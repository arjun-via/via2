"""Run ALO-BestInClass on 10 hard prompts."""
import json
import os
import sys
import time
...
def main():
    print("=" * 80)
    print("ALO-BESTINCLASS: Premium Models")
    print("=" * 80)
    print("Context: Gemini 3 Pro")
    print("Engineering: Claude Sonnet 4.5")
    print("Review: GPT-5.1 (o1)")
    print("=" * 80)

    runner = ALOBestInClassRunner()
    output_dir = Path("benchmark/results/alo_bestinclass")
